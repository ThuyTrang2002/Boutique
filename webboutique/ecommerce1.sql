...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2022 at 05:16 PM
...
(6, 'Nguyen Truong Giang', 'giang truong', 'giang@gmail.com', '0334555686', 237, 'nam dinh\r\ntnp', 'Ha Noi', 'ha noi', 'acd', 'Nguyen Truong Giang', 'giang truong', '0334555686', 237, 'nam dinh\r\ntnp', 'Ha Noi', 'ha noi', 'acd', 'Nguy Huy Tu', 'Tu nguy', '01234878', 237, 'nam dinh', 'nam dinh', 'asdas', 'asdad', '736e4f8c57cce86408c5d3d623c94eca', 'be5a5b2baf82670813455cc9f5645719', '2022-11-24 11:55:50', '1669276550', 1),
(7, 'Do Thuy Trang', 'Trang lun', 'trang@gmail.com', '0214878522', 237, 'bac ninh', 'ha noi', 'ha noi', 'abans', '', '', '', 0, '', '', '', '', '', '', '', 0, '', '', '', '', '781e5e245d69b566979b86e28d23f2c7', '0f0537670c129ad08bd5ce57113e0598', '2022-11-24 07:46:31', '1669304791', 1),
(8, 'Ng?y Huy Tú', 'Tu nguy', 'tu@gmail.com', '021311255', 237, 'nam dinh', 'nam dinh', 'asdas', 'asdad', '', '', '', 0, '', '', '', '', '', '', '', 0, '', '', '', '', '781e5e245d69b566979b86e28d23f2c7', 'f0d9b5a64a61907c8765a9c08e42280c', '2022-11-25 01:30:21', '1669368621', 1),
(9, 'trần minh anh', 'minh anh', 'minhanh@gmail.com', '078445656', 237, 'nam dinh\r\ntnp', 'Hà Nội', 'Hà nội', 'acd', '', '', '', 0, '', '', '', '', '', '', '', 0, '', '', '', '', '781e5e245d69b566979b86e28d23f2c7', 'e4ae60acc576a549b64b522c16029196', '2022-11-28 01:40:53', '1669574453', 1);
...
(54, 84, 'qwqweqeq', '40', 'Blue', '10', '180', '1669345030'),
(55, 77, 'Laptop Backpack', '', 'Black', '3', '100', '1669562914'),
(56, 79, 'Glamorous Shirt Dress For Women', 'S', 'Gray', '3', '85', '1669562914'),
(57, 80, 'Jeans for Women - Denim', 'Free Size', 'Blue', '3', '249', '1669562914'),
(58, 82, 'men\'s soccer shoes', '', 'Black', '1', '80', '1669563200');
...
CREATE TABLE `tbl_page` (
  ...
  `contact_banner` varchar(200) NOT NULL,
  ...
  `pgallery_title` varchar(200) NOT NULL,
  `pgallery_banner` varchar(200) NOT NULL,
  `pgallery_meta_title` varchar(200) NOT NULL,
  `pgallery_meta_keyword` mediumtext NOT NULL,
  `pgallery_meta_description` mediumtext NOT NULL,
  `vgallery_title` varchar(200) NOT NULL,
  `vgallery_banner` varchar(200) NOT NULL,
  `vgallery_meta_title` varchar(200) NOT NULL,
...
(1, 'About Us', '<h1 style=\"box-sizing: inherit; margin-top: 0.67em; margin-bottom: 0.67em; font-size: 2em; font-family: Roboto, Helvetica, Arial, sans-serif; color: rgb(51, 51, 51);\">About Us - Our Story</h1><p class=\"lead\" style=\"box-sizing: inherit; color: rgb(51, 51, 51); font-family: Roboto, Helvetica, Arial, sans-serif;\">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters,</p><p style=\"box-sizing: inherit; color: rgb(51, 51, 51); font-family: Roboto, Helvetica, Arial, sans-serif; font-size: 14px;\">Rhone was the collective vision of a small group of weekday warriors. For years, we were frustrated by the lack of activewear designed for men and wanted something better. With that in mind, we set out to design premium apparel that is made for motion and engineered to endure. Advanced materials and state of the art technology are combined with heritage craftsmanship to create a new standard in activewear. Every product tells a story of premium performance, reminding its wearer to push themselves physically without having to sacrifice comfort and style. Beyond our product offering, Rhone is founded on principles of progress and integrity. Just as we aim to become better as a company, we invite men everywhere to raise the bar and join us as we move Forever Forward.</p>', 'about-banner.jpg', ' About Us', 'about, about us, about fashion, about company, about fashionys', 'BlogITCode provide helpful video about install open source, scripts code PHP & MYSQL, content management system, website. Share best collection effect video intro HD 4K No Copyright', 'FAQ', 'faq-banner.jpg', 'FAQ', '', '', 'Blog', 'blog-banner.jpg', 'Ecommerce - Blog', '', '', 'Contact Us', 'contact-banner.jpg', 'Contact', '', '', 'Photo Gallery', 'pgallery-banner.jpg', 'Ecommerce - Photo Gallery', '', '', 'Video Gallery', 'vgallery-banner.jpg', 'Ecommerce - Video Gallery', '', '');
...
(52, 6, 'Nguyen Truong Giang', 'giang@gmail.com', '2022-11-27 22:33:20', '', 180, '', '', '', '', 'sadaas', 'Bank Deposit', 'Completed', 'Completed', '1669563200'),
(51, 6, 'Nguyen Truong Giang', 'giang@gmail.com', '2022-11-27 16:28:34', '', 1402, '', '', '', '', 'abcde', 'Bank Deposit', 'Completed', 'Completed', '1669562914'),
(50, 6, 'Nguyen Truong Giang', 'giang@gmail.com', '2022-11-25 06:57:10', '', 1900, '', '', '', '', 'asasdqaas', 'Bank Deposit', 'Completed', 'Completed', '1669345030');
...
CREATE TABLE `tbl_product` (
  ...
  `p_entry_price` varchar(10) NOT NULL,
...
INSERT INTO `tbl_product` (`p_id`, `p_name`, `p_old_price`, `p_current_price`, `p_entry_price`, `p_qty`, `p_featured_photo`, `p_description`, `p_short_description`, `p_feature`, `p_condition`, `p_return_policy`, `p_total_view`, `p_is_featured`, `p_is_active`, `ecat_id`) VALUES
(77, 'Laptop Backpack', '', '100', '50', 7, 'product-featured-77.jpg', '<div><font color=\"#0a0a0a\" face=\"opensans, Helvetica Neue, Helvetica, Helvetica, Arial, sans-serif\">Distinct design and pockets galore The striking, modern look of the Skedaddle Laptop Backpack exudes confidence with multi-functional pockets and protects your laptop.<br></font></div>', 'Baggallini Skedaddle Laptop Backpack specifically for women.', '<table>\r\n<tbody><tr>\r\n<td>Brand: </td>\r\n<td>Baggallini</td>\r\n</tr>\r\n<tr>\r\n<td>Features: </td>\r\n<td>Pockets: 3 interior slip, 3 interior zip, 4 exterior</td>\r\n</tr>\r\n<tr>\r\n<td>Target Group: </td>\r\n<td>Women</td>\r\n</tr>\r\n<tr>\r\n<td>Country of Origin: </td>\r\n<td>U.S.A</td>\r\n</tr>\r\n</tbody></table>', 'This product is directly shipped from U.S.A. and it includes import duty in the price.', '<p>Standard Return Policy</p>', 11, 1, 1, 60),
(78, 'Blouse for Women', '110', '50', '30', 10, 'product-featured-78.jpg', '<p>Stripes pattern with small metal beads on strap</p><p>Pair this top with your favorite pants for that casual classy look</p><p>Size on model: S</p>', '<p>This sleeveless blouse is made of 55% Viscose, 43% Polyamide, 2% Spandex<br></p>', '<p><table></p><p><tr></p><p><td>Brand: </td></p><p><td>Guess</td></p><p></tr></p><p><tr></p><p><td>Occasion: </td></p><p><td>Casual Dress</td></p><p></tr></p><p><tr></p><p><td>Material: </td></p><p><td>Mixed Materials</td></p><p></tr></p><p><tr></p><p><td>Sleeve Length: </td></p><p><td>Sleeveless</td></p><p></tr></p><p></table></p>', '<p>Standard Terms & Conditions<br></p>', '<p>Standard Return Policy</p>', 3, 0, 1, 33),
(79, 'Glamorous Shirt Dress For Women', '100', '85', '50', 7, 'product-featured-79.jpg', '<p><span style=\"color: rgb(10, 10, 10); font-family: opensans, \"Helvetica Neue\", Helvetica, Helvetica, Arial, sans-serif;\">Show off your style in Glamorous’ Shirt dress for women. Crafted with soft and rich Polyester material, this dress will offer you great comfort and flair. Flaunt in glamour by pairing it with a matching footwear to experience a sophisticated take on every day wear by making a unique style statement wherever you go.</span><br></p>', '<p><span style=\"color: rgb(51, 51, 51); font-family: opensans, \"Helvetica Neue\", Helvetica, Helvetica, Arial, sans-serif; font-size: 14px;\">Show off your style in Glamorous’ Shirt dress for women. Crafted with soft and rich Polyester material, this dress will offer you great comfort and flair. Flaunt in glamour by pairing it with a matching footwear to experience a sophisticated take on every day wear by making a unique style statement wherever you go.</span><br></p>', '<p>N/A</p>', '<p>N/A</p>', '<p>N/A</p>', 17, 1, 1, 32),
(80, 'Jeans for Women - Denim', '', '249', '150', 7, 'product-featured-80.jpg', '<p><span style=\"color: rgb(10, 10, 10); font-family: opensans, \"Helvetica Neue\", Helvetica, Helvetica, Arial, sans-serif;\">Looking for a way to diversify your attire for the day then go ahead and wear these jeans from the house of Guess. Made of cotton, these jeans will let your skin breathe, keeping you comfortable all day long. Team them with a white colored top to complete your casual look.</span><br></p>', '<p><span style=\"color: rgb(10, 10, 10); font-family: opensans, \"Helvetica Neue\", Helvetica, Helvetica, Arial, sans-serif;\">Looking for a way to diversify your attire for the day then go ahead and wear these jeans from the house of Guess. Made of cotton, these jeans will let your skin breathe, keeping you comfortable all day long. Team them with a white colored top to complete your casual look.</span><br></p>', '<p><span style=\"color: rgb(10, 10, 10); font-family: opensans, \"Helvetica Neue\", Helvetica, Helvetica, Arial, sans-serif;\">Looking for a way to diversify your attire for the day then go ahead and wear these jeans from the house of Guess. Made of cotton, these jeans will let your skin breathe, keeping you comfortable all day long. Team them with a white colored top to complete your casual look.</span><br></p>', '<p>Standard Terms & Conditions    </p>', '<p>Standard Return Policy</p>', 8, 1, 1, 35),
(81, 'Black Wool Beanie & Bobble Hat For Unisex', '10', '1', '1', 9, 'product-featured-81.jpg', '<p>These Soft Knit Cap is a warm and comfortable choice.&nbsp;</p><p>Soft material will make you feel so comfortable and will make you look so special in the crowd .</p><p>This Men\'s Soft Lined Thick Knit Cap Warm Winter beanies Hat with Fully lined it warmth and comfort, very soft.</p>', '<p>These Soft Knit Cap is a warm and comfortable choice.&nbsp;</p><p>Soft material will make you feel so comfortable and will make you look so special in the crowd .</p><p>This Men\'s Soft Lined Thick Knit Cap Warm Winter beanies Hat with Fully lined it warmth and comfort, very soft.</p>', '<p>These Soft Knit Cap is a warm and comfortable choice.&nbsp;</p><p>Soft material will make you feel so comfortable and will make you look so special in the crowd .</p><p>This Men\'s Soft Lined Thick Knit Cap Warm Winter beanies Hat with Fully lined it warmth and comfort, very soft.</p>', '<p>Fashionys.com Standard Terms &amp; Conditions</p>', '<p>Fashionys.com Standard Return Policy<br></p>', 15, 1, 1, 1),
(82, 'men\'s soccer shoes', '100', '80', '45', 49, 'product-featured-82.png', '<p>aqaaaaaaa</p>', '<p>aaaaaaa</p>', '<p>aaaaaa</p>', '<p>aaaaaa</p>', '<p>aaaaaaaaa</p>', 5, 0, 1, 11),
(83, 'men\'s soccer shoes 214545', '200', '150', '80', 50, 'product-featured-83.png', '<p>ghjhjhjbjbh</p>', '<p>jhyrtruiyouh</p>', '<p>frwazssdzd</p>', '<p>fdfcgfghg</p>', '<p>rwtxchgj</p>', 0, 1, 0, 11),
(84, 'qwqweqeq', '200', '180', '100', 40, 'product-featured-84.png', '<p>dqdwqwdqwd</p>', '<p>asdasczxczqw</p>', '<p>qwasdacqwevqwasd</p>', '<p>qwettjfghf</p>', '<p>ncncbtyrty</p>', 6, 1, 1, 11);
...
CREATE TABLE `tbl_settings` (
  ...
  `receive_email` varchar(200) NOT NULL,
  ...
  `banner_login` varchar(200) NOT NULL,
  `banner_registration` varchar(200) NOT NULL,
  `banner_forget_password` varchar(200) NOT NULL,
  `banner_reset_password` varchar(200) NOT NULL,
  `banner_search` varchar(200) NOT NULL,
  `banner_cart` varchar(200) NOT NULL,
  `banner_checkout` varchar(200) NOT NULL,
  `banner_product_category` varchar(200) NOT NULL,
  `banner_blog` varchar(200) NOT NULL,
  `cta_title` varchar(200) NOT NULL,
  `cta_content` mediumtext NOT NULL,
  `cta_read_more_text` varchar(200) NOT NULL,
  `cta_read_more_url` varchar(200) NOT NULL,
  `cta_photo` varchar(200) NOT NULL,
  ...
  `testimonial_photo` varchar(200) NOT NULL,
  `blog_title` varchar(200) NOT NULL,
...
(1, 'slider-1.jpg', 'Welcome to Nobles.com', 'Shop Online for Latest Women Accessories', 'Shop Women Accessories', '', 'Center'),
(5, 'slider-5.jpg', '50% Discount on All Products', 'Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has.', 'Read More', '#', 'Center'),
(6, 'slider-6.jpg', '24 Hours Customer Support', 'Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has.', 'Read More', '#', 'Right');
...
(6, 'YouTube', 'Youtobe', 'fa fa-youtube'),
(7, 'Instagram', 'Instagram', 'fa fa-instagram'),
...
(1, 'Nguyễn Trường Giang', 'admin@gmail.com', '0334555686', '81dc9bdb52d04dc20036dbd8313ed055', 'user-1.jpg', 'Super Admin', 'Active');
